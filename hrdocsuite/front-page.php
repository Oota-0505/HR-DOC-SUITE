  ...
  <main>
        ...
        <div class="hero-inner">
          <div class="hero-glass-panel">
            <div class="hero-content">
              <p class="hero-label">/ DOCUMENT × STANDARD /</p>
              <h1 class="hero-title">
                <span class="t-line">採用と評価の</span><br>
                <span class="t-line">"書類作り"に、</span><br>
                <span class="t-line">共通の型を。</span>
              </h1>
              <p class="hero-lead">
                人が増えるほど、書類も増える。HR DOC SUITE は、中小企業の人事・経営者向けに、採用・評価に必要なドキュメントの型をまとめて提供する月額制のテンプレートサービスです。
              </p>
              <div class="cta-row">
                <a class="btn btn-entry-hero" href="<?php echo esc_url(home_url('/register')); ?>">
    ...
    <section id="empathy" class="section problem-section">
      <div class="container">
        ...
        <p class="section-lead" style="text-align: center; margin-bottom: var(--spacing-xl); max-width: 800px; margin-left: auto; margin-right: auto;">日々の業務に追われ、本来やるべき「人に向き合う時間」が削られていませんか。</p>
    ...
    <section id="cta" class="section cta">
      ...
      <div class="cta-network-pattern"></div>
      <div class="cta-divider"></div>
      <div class="container">
        <div class="cta-inner">
          <div class="cta-content">
            <p class="cta-label">/ お申し込み /</p>
            <h2 class="cta-title">Download</h2>
            <p class="cta-subtitle">採用・評価を"誰がやってもブレない仕組み"に。</p>
            <div class="cta-button-wrapper">
              <a href="<?php echo esc_url(home_url('/register')); ?>" class="btn btn-entry-hero">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                詳しく見る →
              </a>
            </div>
      ...
      <div class="cta-slogan-wrapper">
        <div class="cta-slogan">
          <span class="cta-slogan-text">HR DOC SUITE</span>
          <span class="cta-slogan-text">HR DOC SUITE</span>
          <span class="cta-slogan-text">HR DOC SUITE</span>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="company-wrapper">
          ...
          <div class="company-info">
            <dl class="company-list">
              ...
              <div class="company-item">
                <dt>売上高</dt>
                <dd>
                  107,532,000円（2023年度実績）<br>
                  175,138,000円（2024年度実績）<br>
                  105,743,000円（2025年度実績）<br>
                  216,000,000円（2026年度見込）
                </dd>
              </div>
              <div class="company-item">
                <dt>所在地</dt>
                <dd>〒460-0002<br>愛知県名古屋市中区丸の内1-15-20<br>ie丸の内ビルディング2階</dd>
              </div>
              <div class="company-item">
                <dt>TEL</dt>
                <dd>052-228-0718</dd>
              ...
              <div class="company-item">
                <dt>アクセス</dt>
                <dd>
                  地下鉄桜通線・鶴舞線/「丸の内駅」より徒歩3分<br>
                  地下鉄桜通線/「国際センター駅」より徒歩5分<br>
                  JR/「名古屋駅」より徒歩約14分
                </dd>
              </div>
            </dl>
          ...
          <div class="company-map">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3261.445789812345!2d136.900123456789!3d35.167789012345!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6003709b12345678%3A0x1234567890abcdef!2z44CSNDYwLTAwMDIg5oSb5bed5Yy65ZCR5p6X5biC5Lit5Yy65p6X6YeO77yS5p6X6YeO77yR!5e0!3m2!1sja!2sjp!4v1234567890123!5m2!1sja!2sjp" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div>
        </div>
      </div>
    </section>
